...
while ($row = sqlsrv_fetch_array($res, SQLSRV_FETCH_ASSOC)) {
    // Append each row as an associative array to $inval
    $inval[] = array(
        'subtest' => $row['subtest'],
        'value' => $row['inval']
    );
    // Append each subtest to $subtest
    $subtest[] = $row['subtest'];
}
                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <?php
                                   for ($i = 0; $i < count($subtest); $i++) :
                                    $currentInval = '';
                                    foreach ($inval as $item) {
                                        if ($item['subtest'] === $subtest[$i]) {
                                            $currentInval = $item['value'];
                                            break;
                                        }
                                    }
                                    ?>
                                    ...
                                    <input class="form-control" type="hidden" value="Biochemistry" name="modality">
                                        ...
                                        <div class="col-md-2">
                                            <input class="form-control" type="text" name="subtest[]"
                                                value="<?php echo $subtest[$i]; ?>" readonly>
                                        </div>
                                        <div class="col-md-2">
                                            <input class="form-control" type="text" name="inval[]"
                                                value="<?php echo $currentInval; ?>" tabindex="1" onchange="updateIntval()"
                                                id="bilirubin">
                                        </div>
                                        <div class="col-md-2">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control" type="text" name="inval[]" tabindex="2" id="conjugated"
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="inval[]" tabindex="3" onchange="updateIntval()"
                                            id="unconjugated">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                                ...
                                <div class="form-group row mt-3" >
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="inval[]" id="totalprotin" onchange="Intvalp()" tabindex="7">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                                            <option>--Select--</option>
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="inval[]" tabindex="8" onchange="Intvalp()" id="albumin">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                                            <option>--Select--</option>
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="normrang[]" value="3.5 - 5.5 gm/dl." readonly>
                                    </div>
                                </div>
                                <?php endif; ?>
                                <?php if (!$hideRow): ?>
                                ...
                                <div class="form-group row mt-3" >
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="inval[]" tabindex="9" id="Globulin">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                                            <option>--Select--</option>
                                ...
                                <div class="form-group row mt-3" >
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="inval[]" id="agration" onchange="Intvalp()"
                                            tabindex="10">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                        ...
                        <div class="box-body">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="inval[]" id="cholestrol"
                                            onchange="UpdateLipid()" tabindex="16">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                                            <option>--Select--</option>
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="inval[]" id="triglycerides"
                                            onchange="UpdateLipid()" tabindex="17">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                                            <option>--Select--</option>
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="inval[]" id="hdlCholesterol"
                                            onchange="UpdateLipid()" tabindex="18">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                                            <option>--Select--</option>
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="inval[]" id="ldlCholesterol"
                                            onchange="UpdateLipid()" tabindex="19">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                                            <option>--Select--</option>
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" onchange="UpdateLipid()"
                                            id="vldlcholesterol" name="inval[]" tabindex="20">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                                            <option>--Select--</option>
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" type="text" name="inval[]" onchange="UpdateLipid()"
                                            id="cholestrolHDL" tabindex="21">
                                    </div>
                                    <div class="col-md-2">
                                        <select name="status[]" class="form-control">
                                            <option>--Select--</option>
