                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input list="city" name="rcity" id="rcity" class="form-control" value="<?php echo $city; ?>"
                                                tabindex="8">
                                            <datalist id="city">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input list="deptlist" name="dept" id="dept" tabindex="9" value="<?php echo $dept; ?>" onchange="getDeptDoctors(this.value)" class="form-control">
