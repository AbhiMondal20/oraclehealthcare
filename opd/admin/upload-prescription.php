...
$sql = "SELECT TOP 1 id, rno, opid, rdate, rtime, rfname, CONCAT(rfname, ' ', COALESCE(rmname, ''), ' ', rlname) AS pname, rsex, rage, fname, phone, radd1, rcity, rdist, wamt, addedBy, rdoc FROM registration WHERE id = '$id' AND rno = '$rno'";
