...
<div class="content-wrapper">
    <div class="container-full">
        ...
        if (isset($_POST['search'])) {
            $billno = $_POST['billno'];
            $sqlMain = "SELECT rno, pname, phone, rdocname, billno, billdate, totalPrice, totalAdj, gst, billAmount, paidAmount, balance, status, uname, opid FROM billingDetails WHERE billno = '$billno'";
