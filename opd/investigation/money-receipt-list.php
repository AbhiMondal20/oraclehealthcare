                                            ...
                                            <div class="list-icons d-inline-flex">
                                                <div class="list-icons-item dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end" style="">
                                                        ...
                                                        <a href="mpdfview?rno=<?php echo $rno ; ?>&billno=<?php echo $billno ?>&billdate=<?php echo $billdate ?>", target="_blank" class="dropdown-item"><i class="fa fa-print"></i>Bill Cum Receipt</a>
