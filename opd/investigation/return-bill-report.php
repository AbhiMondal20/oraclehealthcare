                            ...
                            <table id="example" class="table table-hover display nowrap margin-top-10 w-p100">
                                ...
                                <tbody>
                                    ...
                                    // if (isset($_POST['search'])) {
                                        $sql = "SELECT rb.id, rb.rno, rb.pname, rb.phone, rb.rdocname, rb.billno, rb.billdate, rb.totalPrice, rb.totalAdj, rb.gst, rb.billAmount, rb.paidAmount, rb.balance, rb.status, rb.addedBy, rb.opid, b.servname, b.servrate FROM returnbillingDetails AS rb 
