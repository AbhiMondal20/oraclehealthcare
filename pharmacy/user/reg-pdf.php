...
<div class="content-wrapper">
    <div class="container-full">
        ...
        <section class="invoice printableArea">
            ...
            $sql = "SELECT id, rno, opid, rdate, rtime, rfname, CONCAT(rfname, ' ', COALESCE(rmname, ''), ' ', rlname) AS fullname, rsex, rage, fname, phone, radd1, rcity, rdist, wamt, addedBy, rdoc, dept
            FROM registration 
