...
while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC)) {
    ...
    $se = $row['se'];
    $rdate = $row['rdate'];
    $rtime = $row['rtime']; // Corrected assignment for time
    ...
    $wamt = $row['wamt']; // No need for floatval conversion
    $dept = $row['dept'];
    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">Update Registration</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input list="city" name="rcity" id="rcity" class="form-control" value="<?php echo $rcity; ?>"
                                                tabindex="8">
                                            <datalist id="city">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input list="deptlist" name="dept" id="dept" tabindex="9"
                                                onchange="getDeptDoctors(this.value)" value="<?php echo $dept; ?>" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input list="doctlist" name="rdoc" id="rdoc" tabindex="10"
                                                onchange="getDocname(this.value)" value="<?php echo $rdoc ?>" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="controls">
                                                <h5>Fee</h5>
                                                <input type="text" class="form-control" name="wamt" id="wamt" readonly value="<?php echo $wamt ?>"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
