...
<div class="content-wrapper">
    <div class="container-full">
        ...
        <section class="invoice printableArea">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="page-header">
                        <center>
                            <h2 class="d-inline"><span class="fs-30">REGISTRATION RECEIPT (REVISIT)</span></h2>
                        </center>
                    </div>
                </div>
                <!-- /.col -->
            ...
            $opid = $_GET['opid'];
            $rno = $_GET['rno'];
            $sql = "SELECT TOP 1 id, rno, opid, rdate, rtime, rfname, CONCAT(rfname, ' ', COALESCE(rmname, ''), ' ', rlname) AS fullname, rsex, rage, fname, phone, radd1, rcity, rdist, wamt, addedBy, visitType, rdoc, dept
            FROM registration 
                ...
                <div class="col-md-12 invoice-col">
                    ...
                    <address>
                        ...
                        <strong class="text-blue fs-16">Age/Gender :
                            <?php echo $rage; ?> / <?php echo $rsex; ?><br>
                            Visit Type: <?php echo $visitType; ?>
                        </strong><br>
                    </address>
                </div>
                <!-- /.col -->
