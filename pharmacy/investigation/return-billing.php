...
if (isset($_POST['search'])) {
    ...
    $stmt = mysqli_query($conn, $sqlMain);
...
<script>
    function getservname(servname) {
        ...
        $.ajax({
            url: "../admin/load/fetch_price.php",
            type: "POST",
...
<script>
    $(document).ready(function () {
        function getServiceRates(servname) {
            console.log(servname);
            $.ajax({
                url: "../admin/load/get_fetch_price.php",
                type: "POST",
                data: { servname: servname },
                dataType: "json",
                success: function (data) {
...
if (isset($_POST['billSave'])) {
    ...
    $sql = "INSERT INTO returnbillingDetails (rno, opid, pname, phone, rdocname, billno, billdate, totalPrice, totalAdj, billAmount, paidAmount, balance, status, addedBy)
            VALUES ('$rno', '$opid', '$pname', '$phone', '$rdocname', '$billno', '$billdate', '$totalPrice', '$totalAdj', '$billAmount', '$paidAmount', '$balance', '$status', '$username')";
    ...
    if ($res) {
        ...
        foreach ($_POST['servnames'] as $i => $servnames) {
            ...
            $sql = "INSERT INTO returnBilling (rno, opid, pname, billno, billdate, rdocname, servname, servrate, addedBy)
                    VALUES ('$rno', '$opid', '$pname', '$billno', '$billdate', '$rdocname', '$servnames', '$servrates', '$username')";
            $res = mysqli_query($conn, $sql);
            if ($res) {
