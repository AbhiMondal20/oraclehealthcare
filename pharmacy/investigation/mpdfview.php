...
if (!empty($rno1) && !empty($billno1)) {
    ...
    mysqli_stmt_bind_param($stmt1, "ii", $rno1, $billno1);
...
$html2 = '<table id="myTable" style="margin: 0 auto; padding: 0px;">
    ...
    FROM billing AS b 
    WHERE b.rno = ? AND b.billno = ?
    GROUP BY b.servname, b.servrate";

$stmt = mysqli_prepare($conn, $sql);
mysqli_stmt_bind_param($stmt, "ii", $rno1, $billno1);
...
// $mpdf-> AddPage();
// $mpdf-> AddPage();
$css = file_get_contents('../admin/css/pdfcss.css');
